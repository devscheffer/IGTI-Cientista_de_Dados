...
('123456789', 'Alice', 'F', TO_DATE('31-Dec-1978','dd-Mon-YYYY'), 'Daughter'),
('123456789', 'Elizabeth', 'F', TO_DATE('05-May-1957' ,'dd-Mon-YYYY'), 'Spouse'),
('123456789', 'Michael', 'M', TO_DATE('01-Jan-1978' ,'dd-Mon-YYYY'), 'Son'),
('333445555', 'Alice', 'F', TO_DATE('05-Apr-1976' ,'dd-Mon-YYYY'), 'Daughter'),
('333445555', 'Joy', 'F', TO_DATE('03-May-1948' ,'dd-Mon-YYYY'), 'Spouse'),
('333445555', 'Theodore', 'M', TO_DATE('25-Oct-1973' ,'dd-Mon-YYYY'), 'Son'),
('987654321', 'Abner', 'M', TO_DATE('29-Feb-1932' ,'dd-Mon-YYYY'), 'Spouse');
